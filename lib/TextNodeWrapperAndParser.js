...
// IDEA TextNodeWrapper is over engineered, can be simplified. simply return the text nodes
...
class CSSHighlightHandler { 
    ...
    setStyle(color, backgroundColor) {
        // p4 set highlight to only work on a class
    ...
    getSafeUUID(){ // p4 can use static in TextNodeWrapper
        return "_" + crypto.randomUUID();
    }
...
// try with out class first
// class HighlighterWalker { // might not be needed
...
//         this.#highlightHandler = new CSSHighlightHandler();
...
//         this.#highlightHandler.setHighlight(range);
//         return true;
//     }
