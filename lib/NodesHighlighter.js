class NodesHighlighter {
    ...
    // Public methods
    nextWord() {
        if (this.#currentNodeIndex > this.#endNodeIndex) {
            return null;
        } else if (this.#currentNodeIndex === this.#endNodeIndex && this.#currentWordIndex > this.#endWordIndex) {
            return null;
        }
