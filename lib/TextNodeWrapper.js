class TextNodeWrapper {
    ...
    /**
     * @description An array of valid HTML tags that can be injected into the DOM.
     * @type {string[]}
     * @private
    ...
    /**
     * @description Error messages for the class.
     * @type {{ nodeFilterFunc: string; initialization: string; }}
     * @private
     */
    #errorMessages = {
    ...
    **/     
    ...
    /**
     * @description  Get the valid HTML tags that can be injected into the DOM.
     * 
     * @type {string[]}
     * @default 'span', 'div', 'p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'
     */
